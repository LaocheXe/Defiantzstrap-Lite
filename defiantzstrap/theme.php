...
e107::js("theme",            'js/bootstrap.min.js');
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="{SITEURL}">{DEFIANTZSTRAP_BRANDING}</a>
        </div>
        <div class="navbar-collapse collapse {DEFIANTZSTRAP_NAV_ALIGN}">
        	{NAVIGATION=main}
         	{DEFIANTZSTRAP_USERNAV: placement=top}
        </div><!--/.navbar-collapse -->
      </div>
    </div>
	...
	<footer >
		...
		<div>
			...
			<div class="col-lg-6 text-right">
				{XURL_ICONS: size=2x}
				{DEFIANTZSTRAP_USERNAV: placement=bottom&dir=up}
			</div>
		</div>
      ...
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
           {NAVIGATION=main}
           <div class="pull-right">{DEFIANTZSTRAP_USERNAV}</div>
          </div><!--/.nav-collapse -->
        </div>
      </div>
    </div>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="./index.html">Defiantzstrap</a>
          <div class="nav-collapse collapse">
             {NAVIGATION=main}
          </div>
        </div>
